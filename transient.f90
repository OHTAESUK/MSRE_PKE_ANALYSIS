SUBROUTINE transient
    ...
    time_march: DO inx_t = 1,n_step-1
        ! =====================================================================================
        ...
        ! =====================================================================================
        T_fin = arr_T_f2(1) - dT_f; 
        arr_T_f2(1:num_delay-1) = arr_T_f2(2:num_delay)   ! shift the stored information
        arr_T_f2(num_delay)     = 0.d0                    ! will be determined at the end
        ! =====================================================================================
        ...
        DO
            ...
            Rho_dyn = Rho_dyn0 + a_f*((T_f1 + T_f2)/2.d0-T_f0) + a_g*(T_g-T_g0) + 14.24E-5
            ...
            END IF
        END DO
        mat_sol_PKE(:,num_delay) = sol_PKE
        arr_T_f2   (  num_delay) = T_f2
    END DO time_march
