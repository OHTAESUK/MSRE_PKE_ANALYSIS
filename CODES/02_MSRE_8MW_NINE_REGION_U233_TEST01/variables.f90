MODULE variables
    ...
    ! (MUTED) REAL(8) :: k_f  = 0.93 ! [-] fraction of heat generated in fuel - that generated in external loop
    ! (MUTED) REAL(8) :: k_g  = 0.07 ! [-] fraction of total power generated in the graphite
    ! (MUTED) REAL(8) :: k_1  = 0.5  ! [-] fraction of heat transferred from graphite which goes to first  fuel lump
    ! (MUTED) REAL(8) :: k_2  = 0.5  ! [-] fraction of heat transferred from graphite which goes to second fuel lump
    ...
    ! (MUTED) REAL(8) :: k_f1  ! [-] fraction of total power generated in lump f1
    ! (MUTED) REAL(8) :: k_f2  ! [-] fraction of total power generated in lump f2
    ...
    ! *** VARAIBLES FOR NINE-REGION MODEL
    REAL(8) :: tau_fa(9)     ! [s] tau for fuel lump 'a' in each region 'i' in sec. ORNL-TM-1070 pg 67
    REAL(8) :: tau_fb(9)     ! [s] tau for fuel lump 'b' in each region 'i' in sec. ORNL-TM-1070 pg 67
    REAL(8) :: ka(9)         ! [-] power generation fraction for fuel lumps 'a' ORNL-TM-1070 pg 67
    REAL(8) :: kb(9)         ! [-] power generation fraction for fuel lumps 'b' ORNL-TM-1070 pg 67
    REAL(8) :: kga(9)        ! [-] heat transferred from for graphite lump to fuel lump 'a' ORNL-TM-1070 pg 67
    REAL(8) :: kgb(9)        ! [-] heat transferred from for graphite lump to fuel lump 'b' ORNL-TM-1070 pg 67
    
    REAL(8) :: mcp_fa(9)     ! [MJ/K] mfi_a * cp_f
    REAL(8) :: mcp_fb(9)     ! [MJ/K] mfi_b * cp_f   
    REAL(8) :: mcp_g (9)     ! [MJ/K] mgi   * cp_g
    
    REAL(8) :: hA(9)         ! [-] hA_fg(1~9)
    
    REAL(8) ::  m_fm
    REAL(8) ::  tau_m = 2.0d0
    REAL(8) ::  W_f1, W_f2, W_f3, W_f4
    ...
    REAL(8) :: T_fa0(9)           ! [C] Initial Temperature
    REAL(8) :: T_fb0(9)           ! [C] Initial Temperature
    REAL(8) :: T_f0 (9)           ! [C] Initial Temperature
    REAL(8) :: T_g0 (9)           ! [C] Initial Temperature
    REAL(8) :: T_fm0              ! [C] Initial Temperature
    
    REAL(8) :: T_fa_prev(9), T_fa_temp(9) ! [C]
    REAL(8) :: T_fb_prev(9), T_fb_temp(9) ! [C]
    REAL(8) :: T_g_prev (9), T_g_temp (9) ! [C]
    REAL(8) :: T_fm_prev,    T_fm_temp    ! [C]
